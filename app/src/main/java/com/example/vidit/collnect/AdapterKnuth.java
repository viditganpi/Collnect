 ...
 */
public class AdapterKnuth extends RecyclerView.Adapter<AdapterKnuth.ViewHolderEvents> {
    private LayoutInflater layoutInflater;
    private ArrayList<Events> listEvents = new ArrayList<>();
    static ArrayList<Events> listEvents1;
    private int mPreviousPosition = 0;
    public AdapterKnuth(Context context){
    ...
    public ViewHolderEvents onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = layoutInflater.inflate(R.layout.custom_row_tab1,viewGroup,false);
