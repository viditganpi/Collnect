 ...
 */
public class AdapterThespian extends RecyclerView.Adapter<AdapterThespian.ViewHolderEvents> {
    private LayoutInflater layoutInflater;
    private ArrayList<Events> listEvents = new ArrayList<>();
    static ArrayList<Events> listEvents1 = new ArrayList<>();
    private int mPreviousPosition = 0;
    public AdapterThespian(Context context){
    ...
    public ViewHolderEvents onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = layoutInflater.inflate(R.layout.custom_row_tab4,viewGroup,false);
