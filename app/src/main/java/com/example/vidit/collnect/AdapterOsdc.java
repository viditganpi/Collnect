 ...
 */
public class AdapterOsdc extends RecyclerView.Adapter<AdapterOsdc.ViewHolderEvents> {
    private LayoutInflater layoutInflater;
    private ArrayList<Events> listEvents = new ArrayList<>();
    static ArrayList<Events> listEvents1 = new ArrayList<>();
    private int mPreviousPosition = 0;
    public AdapterOsdc(Context context){
    ...
    public ViewHolderEvents onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = layoutInflater.inflate(R.layout.custom_row_tab3,viewGroup,false);
